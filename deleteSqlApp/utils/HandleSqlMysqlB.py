...
# @Author: 喵酱
# @time: 2022 - 06 -09
# @File: HandleSqlMysqlC.py
from deleteSqlApp.conf.dbConnectPool.GetMysqlBConnection import GetMySqlBConnection
...
class HandleSqlMysqlB:
    __instance = None

    def __init__(self):
        self.db = GetMySqlBConnection().conn

    # 单例模式
    def __new__(cls, *args, **kwargs):
        if not cls.__instance:
            cls.__instance = super(HandleSqlMysqlB, cls).__new__(cls)
