...
from deleteSqlApp.conf.dbConnectPool.GetKyfActivityConnection import GetKyfActivityConnection
...
class KyfActivityHandleSql:
    __instance = None


    def __init__(self):
        self.db = GetKyfActivityConnection().conn
